...
class DroneManagementCog(Cog):
    ...
    async def toggle_id_prepending(self, context, drones: Greedy[Union[discord.Member, DroneMemberConverter]], hours: Optional[int] = 0):
        '''
    ...
    async def toggle_speech_optimization(self, context, drones: Greedy[Union[discord.Member, DroneMemberConverter]], hours: Optional[int] = 0):
        '''
    ...
    async def toggle_enforce_identity(self, context, drones: Greedy[Union[discord.Member, DroneMemberConverter]], hours: Optional[int] = 0):
        '''
    ...
    async def toggle_drone_glitch(self, context, drones: Greedy[Union[discord.Member, DroneMemberConverter]], hours: Optional[int] = 0):
        '''
