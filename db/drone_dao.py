...
def fetch_drone_with_drone_id(drone_id: str) -> Drone:
    ...
    '''
    return map_to_object(fetchone('SELECT id, drone_id, optimized, glitched, trusted_users, last_activity, temporary_until FROM drone WHERE drone_id = :drone_id', {'drone_id': drone_id}), Drone)
